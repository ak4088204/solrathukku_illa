...
const submits=()=>{
  ...
  axios.post("http://localhost:8080/api/purchase-orders",json).then(function(response){console.log(response)}).catch(function(error){console.log(error)});
  }
  return (
    <div>
        ...
        <div class="col">
          <div class="card h-100">
            ...
            <div class="card-body text-bg-dark  rounded">
              ...
              <hr></hr>
              <h5 class="card-text">Total number of expired products:0</h5>
            </div>
          </div>
        </div>
      </div>
